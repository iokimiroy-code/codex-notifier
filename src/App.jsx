...
const DEFAULT_SETTINGS = {
  ...
  soundSource: "builtin", customSoundName: "",
};
...
const copy = {
  zh: {
    ...
    labels: {
      ...
      pet: "提示角色", customSound: "自定义完成提示音", upload: "上传音频", test: "试播", useBuiltIn: "使用内置声音",
  ...
  en: {
    ...
    labels: {
      ...
      pet: "Notifier companion", customSound: "Custom completion sound", upload: "Upload audio", test: "Test", useBuiltIn: "Use built-in sound",
...
function App() {
  ...
  }), [showToast, t.notices.completed, t.notices.failed, t.notices.waiting]);
  ...
  return <main className={`app-shell ${expanded ? "is-expanded" : "is-collapsed"} ${isDragging ? "is-dragging" : ""}`}>
